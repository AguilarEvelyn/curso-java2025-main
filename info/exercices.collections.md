...
[3]. Utilice la función indexOf de la clase Vector para buscar un elemento en un array de elementos (no se sorprenda, es trivial)

[4]. Defina una lista List con la clase Empleado antes definida (con nombre, apellidos, fecha de contratación y número de empleado). Use la función sort de la clase Collections para ordenar la lista. Use la antigüedad como criterio a seguir (es “mayor” si es más antiguo) y si entraron en el mismo día, utilice el número de empleado para desempatar.
...
[5]. Defina una lista List con la clase que representa una entrada de una agenda, con el nombre, primer apellido, segundo apellido, teléfono, e-mail y móvil. Use la función sort para ordenarla. Use como criterio de ordenación los apellidos y luego el nombre.
...
Diseñe los métodos de codificación y descodificación de los mensajes. Estos se reciben como args del main (entre comillas para respetar los blancos), se pueden pasar a una List con Arrays.asList y con toCharArray de String. Luego se puede usar una pila para invertir letras.
